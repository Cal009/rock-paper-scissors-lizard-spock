...
function gameOver() {
    ...
    if (userScore === 10) {
        message[0].textContent = "Congratulations, you beat the computer! Refresh the page to start again." ;
    } else {
        message[0].textContent = "Game Over! The computer Wins! Refresh the page to start again.";
    }
}